...
public interface IUnionMainChargeService extends IService<UnionMainCharge> {
     ...
     * @return
     */
    List<UnionMainCharge> listByUnionIdAndType(Integer unionId, Integer type) throws Exception;
     ...
     * @throws Exception
     */
    List<UnionMainCharge> listByUnionIdAndTypeAndIsAvailable(Integer unionId, Integer type, Integer isAvailable) throws Exception;
