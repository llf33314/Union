...
public class UnionMainPermitController {
	...
	public String createUnionQRCode(HttpServletRequest request, HttpServletResponse response, @ApiParam(name="id", value = "套餐列表中的id", required = true) @PathVariable("id") Integer id) {
		try {
