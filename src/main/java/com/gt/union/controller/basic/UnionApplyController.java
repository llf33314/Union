...
public class UnionApplyController {
    ...
    public String updateByUnionIdAndApplyStatus(HttpServletRequest request
        ...
        try{
            ...
            this.unionApplyService.updateByUnionIdAndApplyStatus(id, unionId, busUser.getId(), applyStatus);
    ...
    public String save(HttpServletRequest request
        , @ApiParam(name = "applyType", value = "申请推荐加盟类型 1：申请 2：推荐", required = true)
        @PathVariable("applyType") Integer applyType
