...
public class MybatisGenerator {
    ...
    public static final String url = "jdbc:mysql://113.106.202.51:3306/gt_union_ceshi?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&autoReconnect=true&failOverReadOnly=false";
    ...
    public static final String[] generateTables = new String[]{"t_union_card_info","t_union_consume_record"};
