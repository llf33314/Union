...
CREATE TABLE `t_union_brokerage_pay` (
  ...
  `sys_order_no` varchar(60) DEFAULT NULL COMMENT '订单号',
...
CREATE TABLE `t_union_consume` (
  ...
  `discount` double(8,2) DEFAULT NULL COMMENT '折扣',
  `discount_money` double(8,2) DEFAULT NULL COMMENT '折扣抵扣金额',
  `use_integral` double(8,2) DEFAULT NULL COMMENT '使用积分额',
  `integral_money` double(8,2) DEFAULT NULL COMMENT '积分抵扣金额',
  ...
  `sys_order_no` varchar(128) DEFAULT NULL COMMENT '订单号',
  `wx_order_no` varchar(128) DEFAULT NULL COMMENT '微信订单号',
  `alipay_order_no` varchar(128) DEFAULT NULL COMMENT '支付宝订单号',
