...
public interface IUnionCardActivityService {
     ...
     */
    UnionCardActivity getValidByIdAndUnionId(Integer activityId, Integer unionId) throws Exception;
     ...
     * @throws Exception 统一处理异常
     */
    List<UnionCardActivity> listValidByUnionIdAndStatus(Integer unionId, Integer status) throws Exception;
