 ...
 */
@Api(description = "非ERP文本项目")
@RestController
@RequestMapping("/unionProjectText")
public class UnionProjectTextController {
    ...
    @ApiOperation(value = "根据活动项目id和表单信息，保存并提交非Erp活动项目", produces = "application/json;charset=UTF-8")
    ...
    @ApiOperation(value = "根据活动项目id和表单信息，保存非Erp活动项目", produces = "application/json;charset=UTF-8")
