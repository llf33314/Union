...
public class UnionVerifierController {
    ...
    @RequestMapping(value = "/{verifierId}/remove", method = RequestMethod.PUT, produces = "application/json;charset=UTF-8")
    public String removeById(HttpServletRequest request,
