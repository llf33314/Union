...
public class H5BrokerageController {
    ...
    public String toPay(HttpServletRequest request,
        ...
        if (member == null) {
            return memberService.authorizeMemberWx(request, PropertiesUtil.getUnionUrl() + "h5Brokerage/pay/1").toString();
        }
    ...
    public String batchPay(HttpServletRequest request,
        ...
        if (member == null) {
            return memberService.authorizeMemberWx(request, PropertiesUtil.getUnionUrl() + "h5Brokerage/pay/2").toString();
        }
