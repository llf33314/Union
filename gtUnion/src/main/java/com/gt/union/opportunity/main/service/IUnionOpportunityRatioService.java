...
public interface IUnionOpportunityRatioService {
     ...
     */
    UnionOpportunityRatio getValidByUnionIdAndFromMemberIdAndToMemberId(Integer unionId, Integer fromMemberId, Integer toMemberId) throws Exception;
     ...
     * @throws Exception 统一处理异常
     */
    Page pageSupport(Page page, EntityWrapper<UnionOpportunityRatio> entityWrapper) throws Exception;
