...
public class UnionMemberJoinController {
    ...
    public String pageMapByBusIdAndMemberId(HttpServletRequest request, Page page,
                                            ...
                                            @RequestParam(name = "directorPhone", required = false) String directorPhone) throws Exception {
    ...
    public String method(HttpServletRequest request,
                         ...
                         @RequestBody @Valid UnionMemberJoinVO unionMemberJoinVO, BindingResult bindingResult) throws Exception {
